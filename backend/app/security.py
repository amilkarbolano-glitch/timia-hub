...
# Keys que solo el PM puede escribir (configuración administrativa)
ADMIN_KEYS = {"timia_admin_users", "timia_admin_projects", "timia_project_roles", "timia_ans_config", "timia_bbva_ans_config", "timia_holidays"}
...
def can_write_key(p: Principal, key: str) -> bool:
